...
In [MDXLD](https://mdx.org.ai), every domain defines a linked-data context that gives semantic meaning to your data. MDXLD writes it `$context` rather than JSON-LD's `@context`:
