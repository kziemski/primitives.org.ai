...
- **[MDXLD](https://mdx.org.ai)** — our extension of [MDX](https://mdxjs.com). MDX is an
  **open standard authored by the MDX community**, not by us; MDXLD is ours, a **superset**
  of it that adds `$id`, `$type` and `$context` to the frontmatter, making it also a
  superset of YAML-LD. Every valid MDX document is already a valid MDXLD document.
  `$context` is always [`https://schema.org.ai`](https://schema.org.ai), unversioned.
