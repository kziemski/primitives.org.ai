...
describe('API usage patterns', () => {
    it('allows importing all exports', () => {
        const { createRegistry, getRegistry, configureRegistry, model, embeddingModel, DIRECT_PROVIDERS, } = aiProviders;
...
describe('type exports', () => {
    ...
    it('DirectProvider is a subset of ProviderId', () => {
        ...
        const direct = ['openai', 'anthropic', 'google'];
