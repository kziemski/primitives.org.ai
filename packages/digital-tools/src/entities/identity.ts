 ...
 */
export const SecretVersion: Noun = {
 ...
 */
export const SSOConnection: Noun = {
 ...
 */
export const DirectoryUser: Noun = {
 ...
 */
export const DirectoryGroup: Noun = {
 ...
 */
export const OrganizationMember: Noun = {
