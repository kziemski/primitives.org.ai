 ...
 */
export const VideoChannel: Noun = {
 ...
 */
export const StreamingVideo: Noun = {
 ...
 */
export const PlaylistItem: Noun = {
 ...
 */
export const VideoComment: Noun = {
 ...
 */
export const ChannelSubscription: Noun = {
