...
describe('MemoryProvider', () => {
    ...
    describe('create', () => {
        ...
        it('throws error if entity already exists', async () => {
            ...
            await expect(provider.create('User', 'john', { name: 'Jane' })).rejects.toThrow('Entity already exists: User/john');
        });
    ...
    describe('update', () => {
        ...
        it('throws error if entity does not exist', async () => {
            await expect(provider.update('User', 'nonexistent', { name: 'Jane' })).rejects.toThrow('Entity not found: User/nonexistent');
        });
    ...
    describe('events', () => {
        ...
        it('replays events', async () => {
            ...
            await provider.replayEvents({
                type: 'User.created',
                handler: (event) => {
                    replayedEvents.push(event.data.name);
                },
            });
    ...
    describe('actions', () => {
        ...
        it('throws error when cancelling completed action', async () => {
            ...
            await expect(provider.cancelAction(action.id)).rejects.toThrow('Cannot cancel finished action');
        });
